...
#SBATCH --job-name="Optimos V2 Run WK-ORD Proximal Policy Optimization Random MID"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_wk-ord_mid" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_wk-ord_mid.log \
    --log-to-tensor-board \
