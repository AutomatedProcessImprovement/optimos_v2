...
#SBATCH --job-name="Optimos V2 Run consulta_data_mining Proximal Policy Optimization Random HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_consulta_data_mining_hard" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_consulta_data_mining_hard.log \
    --log-to-tensor-board \
