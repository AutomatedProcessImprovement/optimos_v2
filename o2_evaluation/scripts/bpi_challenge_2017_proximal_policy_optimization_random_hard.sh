...
#SBATCH --job-name="Optimos V2 Run BPI_Challenge_2017 Proximal Policy Optimization Random HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_bpi_challenge_2017_hard" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_bpi_challenge_2017_hard.log \
    --log-to-tensor-board \
