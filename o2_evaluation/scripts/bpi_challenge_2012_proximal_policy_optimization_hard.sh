...
#SBATCH --job-name="Optimos V2 Run BPI_Challenge_2012 Proximal Policy Optimization HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/less_actions_proximal_policy_optimization_bpi_challenge_2012_hard.log \
    --log-to-tensor-board \
