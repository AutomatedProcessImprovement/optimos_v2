...
#SBATCH --job-name="Optimos V2 Run purchasing_example Simulated Annealing Random EASY"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_simulated_annealing_random_purchasing_example_easy.log \
    --log-to-tensor-board \
