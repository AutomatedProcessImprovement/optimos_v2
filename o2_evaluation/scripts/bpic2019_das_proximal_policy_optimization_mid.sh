...
#SBATCH --job-name="Optimos V2 Run BPIC2019_DAS Proximal Policy Optimization MID"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_bpic2019_das_mid.log \
    --log-to-tensor-board \
