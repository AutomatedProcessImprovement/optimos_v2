...
#SBATCH --job-name="Optimos V2 Run AC-CRD Proximal Policy Optimization HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_ac-crd_hard" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_ac-crd_hard.log \
    --log-to-tensor-board \
