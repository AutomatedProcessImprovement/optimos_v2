...
#SBATCH --job-name="Optimos V2 Run consulta_data_mining Simulated Annealing Random EASY"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_simulated_annealing_random_consulta_data_mining_easy.log \
    --log-to-tensor-board \
