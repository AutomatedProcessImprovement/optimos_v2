...
#SBATCH --job-name="Optimos V2 Run BPI_Challenge_2017 Proximal Policy Optimization Random EASY"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "less_actions_bpi_challenge_2017_easy" \
    ...
    --log-level DEBUG \
    --log-file ./logs/less_actions_proximal_policy_optimization_random_bpi_challenge_2017_easy.log \
    --log-to-tensor-board \
