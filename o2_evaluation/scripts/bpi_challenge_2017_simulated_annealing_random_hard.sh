...
#SBATCH --job-name="Optimos V2 Run BPI_Challenge_2017 Simulated Annealing Random HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_simulated_annealing_random_bpi_challenge_2017_hard.log \
    --log-to-tensor-board \
