...
#SBATCH --job-name="Optimos V2 Run insurance Proximal Policy Optimization HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_insurance_hard" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_insurance_hard.log \
    --log-to-tensor-board \
