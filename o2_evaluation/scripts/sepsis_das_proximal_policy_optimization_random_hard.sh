...
#SBATCH --job-name="Optimos V2 Run Sepsis_DAS Proximal Policy Optimization Random HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_sepsis_das_hard" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_sepsis_das_hard.log \
    --log-to-tensor-board \
