...
#SBATCH --job-name="Optimos V2 Run callcentre Proximal Policy Optimization Random EASY"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_callcentre_easy" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_callcentre_easy.log \
    --log-to-tensor-board \
