...
#SBATCH --job-name="Optimos V2 Run purchasing_example Simulated Annealing Random MID"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_purchasing_example_mid" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_simulated_annealing_random_purchasing_example_mid.log \
    --log-to-tensor-board \
