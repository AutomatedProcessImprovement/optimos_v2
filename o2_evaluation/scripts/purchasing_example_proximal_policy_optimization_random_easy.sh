...
#SBATCH --job-name="Optimos V2 Run purchasing_example Proximal Policy Optimization Random EASY"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    --name "strict_ordered_purchasing_example_easy" \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_proximal_policy_optimization_random_purchasing_example_easy.log \
    --log-to-tensor-board \
