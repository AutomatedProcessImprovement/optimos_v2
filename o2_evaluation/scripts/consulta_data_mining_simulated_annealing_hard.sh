...
#SBATCH --job-name="Optimos V2 Run consulta_data_mining Simulated Annealing HARD"
...
conda run -n opti2 --no-capture-output python ./o2_evaluation/data_collector.py \
    ...
    --log-level DEBUG \
    --log-file ./logs/strict_ordered_simulated_annealing_consulta_data_mining_hard.log \
    --log-to-tensor-board \
